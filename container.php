...
return new ServiceManager([
    'factories' => [
        ...
        Command\CheckUserOutFromBuilding::class => function (ContainerInterface $container) : callable {
            $buildings = $container->get(BuildingRepositoryInterface::class);

            return function (Command\CheckUserOutFromBuilding $command) use ($buildings) {
